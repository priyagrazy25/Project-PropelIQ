...
namespace Clinical.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260424072022_AddMedicalCodeOverrideFields")]
    partial class AddMedicalCodeOverrideFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinical.Domain.Entities.CptCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clinical.Domain.Entities.DocumentChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocumentChunks", "clinical", t =>
                        {
                            t.HasCheckConstraint("CK_DocumentChunks_OcrConfidence", "[OcrConfidence] >= 0.0 AND [OcrConfidence] <= 1.0");
                        });
                });
            ...
            modelBuilder.Entity("Clinical.Domain.Entities.Icd10Code", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Icd10Codes", "clinical");
                });

            modelBuilder.Entity("Clinical.Domain.Entities.InsuranceVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InsuranceVerifications", "clinical");
                });
            ...
            modelBuilder.Entity("Clinical.Domain.Entities.MedicalCode", b =>
                {
                    ...
                    b.Property<string>("OriginalAiCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("OriginalAiConfidence")
                        .HasColumnType("float");

                    b.Property<string>("OriginalAiDescription")
                        .HasColumnType("nvarchar(max)");
